    ...
    while episode < args.max_episodes:
        ...
        while True:
            ...
            if args.episode_length <= step or (True in done):
                ...
                # 数据写入txt
                with open('score.txt', 'a') as f:  # write reward in .txt
                    f.write(str(format(episode_reward[0], '.2f')))
                    f.write('\n')
                with open('reward.txt', 'a') as f:  # write reward in .txt
                    f.write(str(format(step_reward[0], '.2f')))
                    f.write('\n')
                # 00000000 #
                ...
                if model.loss:
                    ...
                    # # loss数据写入txt
                    # with open('loss.txt', 'a') as f:  # write reward in .txt
                    #     f.write(str(format(model.loss, '.3f')))
                    #     f.write('\n')
...
if __name__ == '__main__':
    ...
    if os.path.exists('reward.txt') and os.path.exists('score.txt'):
